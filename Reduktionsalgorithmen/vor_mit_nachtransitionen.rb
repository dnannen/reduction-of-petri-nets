...
# Alle Vorbereichsstellen der Vorbereichstransition von t hat nur t im Nachbereich
# Alle Kanten die s enthalten sind gleich gewichtet.

def verschmelze_vor_mit_nachbereich(vormitnach)
  index = 1
  # Prüfe alle Stellen
  ...
  # Fürs Protokoll
  puts("Vor- und Nachbereichstransitionen verschmolzen!")
end
